...
parte_dados <- desempenho_aluno[ , c("estudante", "desempenho", "horas")]

# As variáveis "horas" e "tempo de experiência" poderiam ser excluídas
novos_dados_1 <- desempenho_aluno[ , -c(4,5)]

# Supondo que não vamos analisar as linhas de 476 até 522
novos_dados_2 <- desempenho_aluno[ -c(476:522), ]
...
desempenho_aluno[desempenho_aluno$priv == "pública",]

desempenho_aluno[desempenho_aluno$priv == "pública" &
                   desempenho_aluno$desempenho <= 20,]

desempenho_aluno[desempenho_aluno$escola != "A",]

seleciona_escolas <- desempenho_aluno[desempenho_aluno$escola == "C" |
                                        desempenho_aluno$escola == "H",]
...
#####################################
#+ 5.1.3 dplyr basics
#+ In this chapter you are going to learn the five key dplyr 
#+ functions that allow you to solve the vast majority of your data manipulation challenges:
#+ 
